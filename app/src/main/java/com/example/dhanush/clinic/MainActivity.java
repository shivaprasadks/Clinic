...
public class MainActivity extends AppCompatActivity {
    Button prevTab,nxtTab,clrButton;
    /**
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        clrButton  = findViewById(R.id.btnClear);
         nxtTab = findViewById(R.id.btnNext);
        nxtTab.setOnClickListener(new View.OnClickListener() {
         ...
         prevTab = findViewById(R.id.btnBack);
        prevTab.setOnClickListener(new View.OnClickListener() {

            @Override
            public void onClick(View view) {
                mViewPager.setCurrentItem(getItem(-1), true); //getItem(+1) for next
            }
        });

    }
    private int getItem(int i) {
        int tabNum =  mViewPager.getCurrentItem() + i;
        if(tabNum == 0 ) prevTab.setVisibility(View.INVISIBLE);
        else  prevTab.setVisibility(View.VISIBLE);
